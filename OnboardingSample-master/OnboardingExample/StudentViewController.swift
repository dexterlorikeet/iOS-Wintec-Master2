...
//  OnboardingExample
//
//  Created by Ally Tiang on 11/17/18.
...
class StudentViewController: UIViewController, UIScrollViewDelegate {
    ...
    @IBAction func onHomeBtnPress(_ sender: UIButton) {
    ...
    @objc func showNetworkEngineering(sender: UIButton!) {
        print("Showing Network Engineering")
        /*if let vc = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "network engineering") as? ProgrammeController
        {
            present(vc, animated: true, completion: nil)
        }
        */
    ...
    @objc func showSoftwareEngineering(sender: UIButton!) {
        print("Showing Network Engineering")
    }
    
    @objc func showDatabaseAdministration(sender: UIButton!) {
        print("Showing Database Architecture")
    }
    
    @objc func showMultimedia(sender: UIButton!) {
        print("Showing Multimedia and Web Development")
    }
    ...
    func createSlides() -> [Slide2] {
        ...
        slide2.labelTitle.text = "Software Engineering"
        slide2.labelDesc.text = "Viewing all available modules for Software Engineering"
        ...
        slide3.labelTitle.text = "Database Architecture"
        slide3.labelDesc.text = "Viewing all available modules for Database Architecture"
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        slides[3].imageView.transform = CGAffineTransform(scaleX: percentOffset.x/0.75, y: percentOffset.x)
        }
    }
